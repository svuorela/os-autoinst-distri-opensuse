...
our $default_code_base = get_var('IPSEC_TEST') ? 'https://gitlab.suse.de/qe-security/ipsec/-/archive/test-fix/ipsec-main.tar' : 'https://gitlab.suse.de/qe-security/audit-test-sle15/-/archive/test-fix/audit-test-sle15-test-fix.tar';
